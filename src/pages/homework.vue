    ...
    <div class="row">
      <div class="col-4 q-pa-sm">
        <q-toolbar v-if="account.isTeacher" color="secondary">
          <q-toolbar-title>
            <q-btn color="purple-3" size="sm" round @click="addHomework" icon="add" />
          </q-toolbar-title>
        </q-toolbar>
      ...
      <div v-if="selectedHomework" class="col-8 q-pa-sm text-center">
        <small>{{selectedHomework.title}}</small>
        <blockquote class="text-left">
          <small v-html="selectedHomework.detailHtml"></small>
        </blockquote>
        <q-tabs class="q-mt-lg" inverted color="secondary" v-if="selectedHomework.codeSnaps.length > 0" no-pane-border>
